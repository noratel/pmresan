...
local You = 262215616  --ID ADMIN ایدی خود را اینجا قرار دهید
...
local text = "" سلام به ربات پیام رسان نوراتل خوش آمدید لطفا تمام حرفایتان را در یک پیام ارسال کنید و منتظر پاسخ باشید  ["..msg.from.first_name.."](www.telegram.me/"..user..")\n\n[کانال تلگرام ربات](https://telegram.me/noratelinfo)"
